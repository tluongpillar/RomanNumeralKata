...
Suite * roman_numeral_conversion_suite()
{
  ...
  tcase_add_loop_test(tcase_core, test_convert_to_roman_numeral_from_arabic_value__given_1_through_9__returns_I_through_IX, start_index, roman_numeral_ones_digit_length);
