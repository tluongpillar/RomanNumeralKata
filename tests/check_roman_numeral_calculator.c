...
START_TEST(test_perform_operation_with_roman_numerals__given_I_II_subtract__returns_empty_string_with_failure)
{
  char * actual_result = calloc((strlen(MAX_ROMAN_NUMERAL) + 1), sizeof(char));
  char ** actual_result_pointer;
  actual_result_pointer = &actual_result;
...
Suite * roman_numeral_calculator_suite()
{
  ...
  tcase_add_test(tcase_core, test_perform_operation_with_roman_numerals__given_I_II_subtract__returns_empty_string_with_failure);
