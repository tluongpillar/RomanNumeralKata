...
START_TEST(test_add_two_roman_numerals__given_one_operand_null_pointer__returns_INVALID_string)
{
  void * lhs_null_pointer = NULL;
  strcpy(rhs_roman_numeral, "I");

  add_two_roman_numerals(actual_result, lhs_null_pointer, rhs_roman_numeral);

  ck_assert_str_eq(failed_result, actual_result);
}
END_TEST

START_TEST(test_add_two_roman_numerals__given_one_operand_null_pointer__returns_false)
{
  void * lhs_null_pointer = NULL;
  strcpy(rhs_roman_numeral, "I");

  bool did_add_successfully = add_two_roman_numerals(actual_result, lhs_null_pointer, rhs_roman_numeral);
...
START_TEST(test_add_two_roman_numerals__given_A_plus_I__returns_false)
{
...
START_TEST(test_subtract_two_roman_numerals__given_one_operand_null_pointer__returns_false)
{
  ...
  bool did_subtract_successfully = subtract_two_roman_numerals(actual_result, null_pointer, rhs_roman_numeral);
...
START_TEST(test_subtract_two_roman_numerals__given_I_minus_A__returns_false)
{
  strcpy(lhs_roman_numeral, "I");
  strcpy(rhs_roman_numeral, "A");
...
START_TEST(test_subtract_two_roman_numerals__given_I_minus_A__returns_INVALID_string)
{
  strcpy(lhs_roman_numeral, "I");
  strcpy(rhs_roman_numeral, "A");
...
Suite * roman_numeral_operation_suite()
{
  ...
  tcase_add_test(tcase_core, test_add_two_roman_numerals__given_one_operand_null_pointer__returns_INVALID_string);
  tcase_add_test(tcase_core, test_add_two_roman_numerals__given_one_operand_null_pointer__returns_false);
  tcase_add_test(tcase_core, test_add_two_roman_numerals__given_result_null_pointer__returns_false);
  tcase_add_test(tcase_core, test_add_two_roman_numerals__given_A_plus_I__returns_false);
  ...
  tcase_add_test(tcase_core, test_subtract_two_roman_numerals__given_I_minus_A__returns_INVALID_string);
  tcase_add_test(tcase_core, test_subtract_two_roman_numerals__given_I_minus_A__returns_false);
