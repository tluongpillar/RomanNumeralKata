...
START_TEST (test_get_arabic_value_from_roman_numeral_letter__given_invalid_roman_numeral_letters_uppercase__returns_arabic_value_zero)
{
...
START_TEST (test_get_arabic_value_from_roman_numeral_letter__given_invalid_roman_numeral_letters_lowercase__returns_arabic_value_zero)
{
...
START_TEST (test_get_arabic_value_from_roman_numeral_letter__given_roman_numeral_letters_uppercase__returns_expected_arabic_values)
{
  ck_assert_uint_eq(valid_arabic_values[_i], get_arabic_value_from_roman_numeral_letter(valid_roman_numeral_letters[_i]));
}
END_TEST

START_TEST (test_get_arabic_value_from_roman_numeral_letter__given_roman_numeral_letters_lowercase__returns_expected_arabic_values)
{
  char valid_roman_numeral_letter_lowercase = tolower(valid_roman_numeral_letters[_i]);
  ck_assert_uint_eq(valid_arabic_values[_i], get_arabic_value_from_roman_numeral_letter(valid_roman_numeral_letter_lowercase));
}
END_TEST

START_TEST (test_is_roman_numeral_letter__given_invalid_roman_numeral_letters_uppercase__returns_false)
{
  ck_assert(is_roman_numeral_letter(invalid_roman_numeral_letters[_i]) == false);
}
END_TEST

START_TEST (test_is_roman_numeral_letter__given_invalid_roman_numeral_letters_lowercase__returns_false)
{
  char invalid_roman_numeral_letter_lowercase = tolower(invalid_roman_numeral_letters[_i]);
...
START_TEST (test_is_roman_numeral_letter__given_valid_roman_numeral_letters_uppercase__returns_true)
{
  ck_assert(is_roman_numeral_letter(valid_roman_numeral_letters[_i]) == true);
}
END_TEST

START_TEST (test_is_roman_numeral_letter__given_valid_roman_numeral_letters_lowercase__returns_true)
{
  char valid_roman_numeral_letter_lowercase = tolower(valid_roman_numeral_letters[_i]);
...
Suite * roman_numeral_letter_suite()
{
  ...
  tcase_add_loop_test(tcase_core, test_get_arabic_value_from_roman_numeral_letter__given_invalid_roman_numeral_letters_uppercase__returns_arabic_value_zero,start_index , invalid_roman_numeral_letters_length);
  tcase_add_loop_test(tcase_core, test_get_arabic_value_from_roman_numeral_letter__given_invalid_roman_numeral_letters_lowercase__returns_arabic_value_zero,start_index , invalid_roman_numeral_letters_length);
  tcase_add_loop_test(tcase_core, test_get_arabic_value_from_roman_numeral_letter__given_roman_numeral_letters_uppercase__returns_expected_arabic_values, start_index, valid_roman_numeral_letters_length);
  tcase_add_loop_test(tcase_core, test_get_arabic_value_from_roman_numeral_letter__given_roman_numeral_letters_lowercase__returns_expected_arabic_values, start_index, valid_roman_numeral_letters_length);

  tcase_add_loop_test(tcase_core, test_is_roman_numeral_letter__given_invalid_roman_numeral_letters_uppercase__returns_false, start_index, invalid_roman_numeral_letters_length);
  tcase_add_loop_test(tcase_core, test_is_roman_numeral_letter__given_invalid_roman_numeral_letters_lowercase__returns_false, start_index, invalid_roman_numeral_letters_length);
  tcase_add_loop_test(tcase_core, test_is_roman_numeral_letter__given_valid_roman_numeral_letters_uppercase__returns_true, start_index, valid_roman_numeral_letters_length);
  tcase_add_loop_test(tcase_core, test_is_roman_numeral_letter__given_valid_roman_numeral_letters_lowercase__returns_true, start_index, valid_roman_numeral_letters_length);
