...
clean:
	rm roman_numeral_calculator roman_numeral_calculator.o roman_numeral_operation.o roman_numeral_conversion.o roman_numeral_letter.o check_tests check_suite_runner.o check_roman_numeral_operation.o check_roman_numeral_conversion.o check_roman_numeral_letter.o
